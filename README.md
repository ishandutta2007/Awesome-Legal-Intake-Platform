<p align="center">
  <img src="assets/banner.svg" alt="Awesome Legal Intake Platform Banner" width="100%" />
</p>
...
| **[Certbot](https://github.com/certbot/certbot)** 🔒 | [![Certbot Stars](https://img.shields.io/github/stars/certbot/certbot?style=social&color=white)](https://github.com/certbot/certbot/stargazers) | EFF's automated security and SSL certificate tool—essential for securing self-hosted, privilege-compliant legal intake web portals. |
| **[Budibase](https://github.com/Budibase/budibase)** 🏗️ | [![Budibase Stars](https://img.shields.io/github/stars/Budibase/budibase?style=social&color=white)](https://github.com/Budibase/budibase/stargazers) | Open-source low-code application builder ideal for creating custom legal request portals, matter tracking tables, and role-based access flows. |
| **[Documenso](https://github.com/documenso/documenso)** ✍️ | [![Documenso Stars](https://img.shields.io/github/stars/documenso/documenso?style=social&color=white)](https://github.com/documenso/documenso/stargazers) | Open-source e-signature platform that integrates seamlessly into legal intake forms for instant NDAs and approval sign-offs. |
| **[Form.io](https://github.com/formio/formio)** 📝 | [![Form.io Stars](https://img.shields.io/github/stars/formio/formio?style=social&color=white)](https://github.com/formio/formio/stargazers) | Combined JSON schema form builder and API management platform for complex data capture and legal form intake. |
| **[Docassemble](https://github.com/jhpyle/docassemble)** ⚖️ | [![Docassemble Stars](https://img.shields.io/github/stars/jhpyle/docassemble?style=social&color=white)](https://github.com/jhpyle/docassemble/stargazers) | Free, open-source expert system for guided interview building, legal document assembly, and interactive intake questionnaires. |
| **[Iuris-Soft](https://github.com/createrivabu/Iuris-Soft)** 💼 | [![Iuris-Soft Stars](https://img.shields.io/github/stars/createrivabu/Iuris-Soft?style=social&color=white)](https://github.com/createrivabu/Iuris-Soft/stargazers) | Open-source legal management system supporting client contacts, litigation tracking, matter lifecycles, and legal document repositories. |
| **[Whereas CLM](https://github.com/Whereas/whereas)** 📄 | [![Whereas Stars](https://img.shields.io/github/stars/Whereas/whereas?style=social&color=white)](https://github.com/Whereas/whereas/stargazers) | Experimental open-source contract lifecycle management (CLM) and request-to-repository intake workflow project. |
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Legal-Intake-Platform&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Legal-Intake-Platform&type=date&legend=top-left)
